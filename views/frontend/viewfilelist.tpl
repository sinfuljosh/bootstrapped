...
<table style="width:100%;margin-bottom:10px;" class="data Sortable highlight">
	...
	<tr class="{cycle values=",alt"}">
		...
		{assign var="icon" value='templates/bootstrapped/images/fileicons/'|cat:$file.ext|cat:".png"} 
		...
		<td><img title=".{$file.ext}" alt="{$file.ext}" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/fileicons/{$icon}.png" /></td>
