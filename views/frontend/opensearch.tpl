<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/" xmlns:moz="http://www.mozilla.org/2006/browser/search/">
	...
	<Image width="16" height="16">{$serverroot}templates/bootstrapped/images/favicon.ico</Image>
	...
	<moz:IconUpdateUrl>{$serverroot}templates/bootstrapped/images/favicon.ico</moz:IconUpdateUrl>
