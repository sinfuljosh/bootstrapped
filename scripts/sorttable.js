...
function ts_makeSortable(table) {
    ...
    for (var i=0;i<firstRow.cells.length;i++) {
		...
		if ( i==0 ) {
			...
			str_HTML += ' sortdir="down"><img src="' + WWW_TOP + '/templates/bootstrapped/images/sorting/arrow_down.gif" alt="" />';
		}
		else str_HTML += '>';		
...
function ts_resortTable(lnk,clid) {
    ...
    {
       	// ARROW = '&nbsp;&nbsp;&uarr;';
		ARROW = '<img src="' + WWW_TOP + '/templates/bootstrapped/images/sorting/arrow_up.gif" />';
        newRows.reverse();
    ...
    {
        //ARROW = '&nbsp;&nbsp;&darr;';
		ARROW = '<img src="' + WWW_TOP + '/templates/bootstrapped/images/sorting/arrow_down.gif" alt="" />';
