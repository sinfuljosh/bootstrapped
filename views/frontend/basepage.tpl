...
{/if}
	...
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/scripts/jquery.colorbox-min.js"></script>
        ...
        <ul class="nav">
			...
			{else}
              <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropUser">
                  <li><a tabindex="-1" href="{$smarty.const.WWW_TOP}/profile">Login</a></li>
...
{*     			<a class="logolink" title="{$site->title} Logo" href="{$smarty.const.WWW_TOP}{$site->home_link}"><img class="logoimg" alt="{$site->title} Logo" src="{$smarty.const.WWW_TOP}/templates/default/images/clearlogo.png" /></a> *}
      <h1>{$site->title}</h1>
      <p class="lead">A Usenet Indexer</p>
    </div>
  </div>
	{if $loggedin=="true"}
		...
		<div class="span2">
			...
			<div id="sidebar">
				<ul>		
					...
					<li>
						<a title="Sabznbd - A great usenet binary downloader" href="http://www.sabnzbd.org/"><img class="menupic" alt="Sabznbd - A great usenet binary downloader" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sabnzbd.png" /></a>
					</li>
				</ul>
			</div>
