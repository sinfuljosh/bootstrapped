			...
			<ul>
				<li>
					...
					<br/>
					Returns a list of nzbs matching a query. You can also  filter by site category or group name by including a comma separated list as follows <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=search&amp;cat=1000,2000&amp;group=a.b.multimedia">?t=search&amp;cat=1000,2000&amp;group=a.b.multimedia</a></span>. Include <span style="font-family:courier;">&amp;extended=1</span> to return extended information in the search results.
				</li>
				<li>
