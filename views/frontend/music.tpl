...
<table class="rndbtn" border="0" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td><input class="input-medium" id="musicartist" type="text" name="artist" value="{$artist}" size="15" /></td>
		<td><input class="input-medium" id="musictitle" type="text" name="title" value="{$title}" size="15" /></td>
		<td>
		...
		<td>
			<select class="input-mini" id="year" name="year">
			<option class="grouping" value=""></option>
...
<table style="width:100%;" class="data highlight icons" id="coverstable">
	<tr>
		...
		<th>artist<br/><a title="Sort Descending" href="{$orderbyartist_desc}"><img src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyartist_asc}"><img src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sorting/arrow_up.gif" alt="" /></a></th>
