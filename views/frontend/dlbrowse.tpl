...
<table style="width:100%;" class="data highlight" id="browsetable">
	...
	{foreach from=$results item=result}
		<tr class="{cycle values=",alt"}">
			...
			{assign var="icon" value='templates/bootstrapped/images/fileicons/'|cat:$result.pathinfo.extension|cat:".png"} 
			{if $result.isdir == "1"}
			...
			<td><img title=".{$result.pathinfo.extension}" alt="{$result.pathinfo.extension}" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/fileicons/{$icon}.png" /></td>
			<td class="item">
				{if $result.isdir == 1}
