...
<table class="rndbtn" border="0" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td><input  class="input-medium"id="author" type="text" name="author" value="{$author}" size="15" /></td>
...
<table style="width:100%;" class="data highlight icons" id="coverstable">
	<tr>
		...
		<th>author<br/><a title="Sort Descending" href="{$orderbyauthor_desc}"><img src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyauthor_asc}"><img src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sorting/arrow_up.gif" alt="" /></a></th>
