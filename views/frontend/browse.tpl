...
<table style="width:100%;" class="data highlight icons" id="browsetable">
	<tr>
		...
		<th>files<br/><a title="Sort Descending" href="{$orderbyfiles_desc}"><img src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbyfiles_asc}"><img src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
		...
		<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}" id="guid{$result.guid}">
			...
			<label for="chk{$result.guid|substr:0:7}"><a class="title" title="View details" href="{$smarty.const.WWW_TOP}/details/{$result.guid}/{$result.searchname|escape:"seourl"}">{$result.searchname|escape:"htmlall"|replace:".":" "}</a></label>
				...
				{if $result.passwordstatus == 2}
					<img title="Passworded Rar Archive" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/icons/lock.gif" alt="Passworded Rar Archive" />
				{elseif $result.passwordstatus == 1}
					<img title="Contains .cab/ace/rar Archive" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/icons/lock.gif" alt="Contains .cab/ace/rar Archive" />
				{/if}

				{if $userdata.canpre == 1 && $result.nuketype != ''}
					&nbsp;<img title="{$result.nuketype}" src="{$smarty.const.WWW_TOP}/templates/bootstrapped/images/icons/nuke.png" width="10" height="10" alt="{$result.nuketype}" />
				{/if}
