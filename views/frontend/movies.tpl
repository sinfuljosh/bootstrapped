...
<table class="rndbtn" border="0" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td><input class="input-medium" id="movietitle" type="text" name="title" value="{$title}" size="15" /></td>
		<td><input class="input-medium" id="movieactors" type="text" name="actors" value="{$actors}" size="15" /></td>
		<td><input class="input-medium" id="moviedirector" type="text" name="director" value="{$director}" size="15" /></td>
		<td>
			<select class="input-mini" id="rating" name="rating">
